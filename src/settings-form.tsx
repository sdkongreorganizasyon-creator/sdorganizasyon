          ...
          >
            <div className="admin-panel__heading">
              <div>
                ...
                <p>İstediğiniz kartları etkinleştirin; boş alanlar taslak, önizleme veya yayınlamayı engellemez.</p>
              </div>
            </div>
          ...
          >
            ...
            <div className="form-grid form-grid--two">
              ...
              <TextInput
                ...
                hint="Sayfa bölümlerinin üst ve alt boşluğunu belirler."
              />
              <TextInput
                ...
                hint="Kartların kenarları ile içerikleri arasındaki boşluk."
              />
              <TextInput
