...
export function EntityForm({
  ...
  const serviceCardPadding =
    typeof content.cardPadding === "number" ? content.cardPadding : 16;
  const serviceMediaHeight =
    typeof content.mediaHeight === "number" ? content.mediaHeight : 190;
  const serviceContentGap =
    typeof content.contentGap === "number" ? content.contentGap : 10;
