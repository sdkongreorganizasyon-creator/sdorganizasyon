...
export function ServiceCard({ service }: ServiceCardProps) {
  ...
  const style = {
    ...
    "--service-card-padding":
      typeof service.cardPadding === "number"
        ? `${service.cardPadding}px`
        : undefined,
    "--service-media-height":
      typeof service.mediaHeight === "number"
        ? `${service.mediaHeight}px`
        : undefined,
    "--service-content-gap":
      typeof service.contentGap === "number"
        ? `${service.contentGap}px`
        : undefined,
  } as CSSProperties;
